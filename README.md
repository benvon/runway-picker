...
- `Release Create` dispatches production deploy workflows after publishing a release tag
...
- `Deploy Production`: deploy Pages app when a stable GitHub Release is published or when release workflow dispatches a tag deploy
- `Deploy METAR Worker Production`: deploy Worker API when a stable GitHub Release is published or when release workflow dispatches a tag deploy
